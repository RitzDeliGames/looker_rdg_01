...
constant: iap_id_strings_new {
  ...
  case
    ...
    when a.iap_id = 'item_052_loc' then 'Hammer Chum Chums & Coins Special!'
    when a.iap_id = 'item_053_loc' then 'Horizontal Chum Chums & Coins Special!'
    when a.iap_id = 'item_054_loc' then 'Vertical Chum Chums & Coins Special!'
    when a.iap_id = 'item_055_loc' then 'Coins (S)'
    when a.iap_id = 'item_056_loc' then 'Coins (M)'
    when a.iap_id = 'item_057_loc' then 'Coins (L)'
    ...
    when a.iap_id = 'item_075_loc' then 'Shuffle Chum Chums & Coins Special!'
    when a.iap_id = 'item_076_loc' then 'Magnifiers (S)'
    when a.iap_id = 'item_077_loc' then 'Magnifiers (M)'
    when a.iap_id = 'item_078_loc' then 'Magnifiers (L)'
    when a.iap_id = 'item_088_loc' then 'Karma Chum Chums & Coins Special!'
    when a.iap_id = 'item_089_loc' then 'Level Bundle (100)'
    when a.iap_id = 'item_090_loc' then 'Level Bundle (200)'
    when a.iap_id = 'item_091_loc' then 'Level Bundle (300)'
    when a.iap_id = 'item_092_loc' then 'Level Bundle (400)'
    when a.iap_id = 'item_095_loc' then 'Skillet Chum Chums & Coins Special!'
    when a.iap_id = 'item_097_loc' then 'Coins (XL)'
    when a.iap_id = 'item_098_loc' then 'Level Bundle (500)'
    when a.iap_id = 'item_099_loc' then 'Treasure Trove (XL)'
    when a.iap_id = 'item_105_loc' then 'Chopsticks Chum Chums & Coins Special!'
    when a.iap_id = 'item_chopsticks_bulk_loc' then '5x Chopsticks Skill'
    when a.iap_id = 'item_disco_bulk_loc' then '5x Disco Skill'
    when a.iap_id = 'item_disco_unlock_loc' then 'Chum Chum Unlock: Karma Chameleon'
    when a.iap_id = 'item_shuffle_loc' then '1x Shuffle Skill'
    when a.iap_id = 'item_shuffle_bulk_loc' then '5x Shuffle Skill'
    when a.iap_id = 'item_skillet_loc' then '1x Skillet Skill'
    when a.iap_id = 'item_skillet_bulk_loc' then '5x Skillet Skill'
    ...
    when a.iap_id = 'item_bundle_062024_loc' then 'Item Bundle: Extra Moves, Coins, Tickets'
    when a.iap_id = 'item_bundle_100k5tick_loc' then 'Item Bundle: 100K Coins 5 Tickets'
    when a.iap_id = 'item_bundle_3chums_loc' then 'Item Bundle: 3 Chums'
    when a.iap_id = 'item_bundle_halloween1_loc' then 'Halloween: Grim Rewards 1 (Spender)'
    when a.iap_id = 'item_bundle_halloween2_loc' then 'Halloween: Grim Rewards 2 (Non-Spender)'
    when a.iap_id = 'item_bundle_halloween3_loc' then 'Halloween: Grim Rewards 3 (Spender)'
    when a.iap_id = 'item_bundle_halloween4_loc' then 'Halloween: Grim Rewards 4 (Non-Spender Early Game)'
    when a.iap_id = 'item_bundle_halloween5_loc' then 'Halloween: Grim Rewards 5 (Non-Spender Mid/Late Game)'
    when a.iap_id = 'item_chopsticks_loc' then 'Chopsticks'
    when a.iap_id = 'item_096' then 'Betty the Bunny & Coins Special!'
    when a.iap_id = 'item_096_loc' then 'Betty the Bunny & Coins Special!'
    when a.iap_id = 'item_bomb_loc' then '1x Bomb Boost'
    when a.iap_id = 'item_bomb_bulk_loc' then '6x Bomb Boost'
    when a.iap_id = 'item_clear_cell_loc' then '1x Clear Cell Skill'
    when a.iap_id = 'item_clear_cell_bulk_loc' then '5x Clear Cell Skill'
    when a.iap_id = 'item_clear_horizontal_loc' then '1x Clear Horizontal Skill'
    when a.iap_id = 'item_clear_horizontal_bulk_loc' then '5x Clear Horizontal Skill'
    when a.iap_id = 'item_clear_vertical_loc' then '1x Clear Vertical Skill'
    when a.iap_id = 'item_clear_vertical_bulk_loc' then '5x Clear Vertical Skill'
    when a.iap_id = 'item_color_ball_loc' then '1x Color Ball Boost'
    when a.iap_id = 'item_color_ball_bulk_loc' then '5x Color Ball Boost'
    when a.iap_id = 'item_disco_loc' then '5x Disco Skill'
    when a.iap_id = 'item_rocket_loc' then '1x Rocket Boost'
    when a.iap_id = 'item_rocket_bulk_loc' then '8x Rocket Boost'
    when a.iap_id = 'item_moves' then 'Betty the Bunny'
    when a.iap_id = 'item_moves_loc' then 'Betty the Bunny'
    when a.iap_id = 'item_christmas1' then 'Christmas Offer 1'
    when a.iap_id = 'item_christmas2' then 'Christmas Offer 2'
    ...
    when a.iap_id = 'item_moves_bulk' then 'Lots o Betties!'
    when a.iap_id = 'item_moves_bulk_loc' then 'Lots o Betties!'
    when a.iap_id = 'item_129' then 'Mega Coin Pack 1'
    ...
    when a.iap_id = 'item_130' then 'Ultra Coin Pack 1'
    when a.iap_id = 'item_131' then 'Ultra Coin Pack 2'
    when a.iap_id = 'item_132' then 'Ultra Coin Pack 3'
    when a.iap_id = 'item_bundle_blackfriday1' then 'Black Friday Sale 1'
    when a.iap_id = 'item_bundle_blackfriday2' then 'Black Friday Sale 2'
    when a.iap_id = 'item_bundle_blackfriday3' then 'Black Friday Sale 3'
    when a.iap_id = 'item_133' then 'Level Bundle (100)'
    ...
    when a.iap_id = 'item_bundle_flashblastofferlvl50' then 'Level Bundle V2 (L50)'
...
constant: iap_id_strings_grouped_new {
  value: "
    ...
    when a.iap_id = 'battle_pass_loc' then 'Premium Battle Pass'
    when a.iap_id = 'item_008_loc' then 'Gems'
    when a.iap_id = 'item_009_loc' then 'Gems'
    when a.iap_id = 'item_010_loc' then 'Gems'
    when a.iap_id = 'item_011_loc' then 'Gems'
    when a.iap_id = 'item_012_loc' then 'Gems'
    when a.iap_id = 'item_013_loc' then 'Gems'
    when a.iap_id = 'item_026_loc' then 'Gems'
    when a.iap_id = 'item_051_loc' then 'Giant Power Up Pack!'
    when a.iap_id = 'item_052_loc' then 'Chum Chums & Coins'
    when a.iap_id = 'item_053_loc' then 'Chum Chums & Coins'
    when a.iap_id = 'item_054_loc' then 'Chum Chums & Coins'
    when a.iap_id = 'item_055_loc' then 'Coins'
    when a.iap_id = 'item_056_loc' then 'Coins'
    when a.iap_id = 'item_057_loc' then 'Coins'
    ...
    when a.iap_id = 'item_075_loc' then 'Chum Chums & Coins'
    when a.iap_id = 'item_076_loc' then 'Magnifiers'
    when a.iap_id = 'item_077_loc' then 'Magnifiers'
    when a.iap_id = 'item_078_loc' then 'Magnifiers'
    when a.iap_id = 'item_088_loc' then 'Chum Chums & Coins'
    when a.iap_id = 'item_089_loc' then 'Level Bundle'
    when a.iap_id = 'item_090_loc' then 'Level Bundle'
    when a.iap_id = 'item_091_loc' then 'Level Bundle'
    when a.iap_id = 'item_092_loc' then 'Level Bundle'
    when a.iap_id = 'item_095_loc' then 'Chum Chums & Coins'
    when a.iap_id = 'item_097_loc' then 'Coins'
    when a.iap_id = 'item_098_loc' then 'Level Bundle'
    when a.iap_id = 'item_099_loc' then 'Treasure Trove'
    when a.iap_id = 'item_105_loc' then 'Chum Chums & Coins'
    when a.iap_id = 'item_chopsticks_bulk_loc' then 'Chum Chum Skills'
    when a.iap_id = 'item_disco_bulk_loc' then 'Chum Chum Skills'
    when a.iap_id = 'item_disco_unlock_loc' then 'Chum Chum Unlock'
    when a.iap_id = 'item_shuffle_loc' then 'Chum Chum Skills'
    when a.iap_id = 'item_shuffle_bulk_loc' then 'Chum Chum Skills'
    when a.iap_id = 'item_skillet_loc' then 'Chum Chum Skills'
    when a.iap_id = 'item_skillet_bulk_loc' then 'Chum Chum Skills'
    ...
    when a.iap_id = 'item_109_loc' then 'Halloween: Treasure Trove'
    when a.iap_id = 'item_114_loc' then 'Halloween: Treasure Trove'
    when a.iap_id = 'item_118_loc' then 'Halloween: Treasure Trove'
    when a.iap_id = 'item_121_loc' then 'Halloween: Treasure Trove'
    when a.iap_id = 'item_bundle_062024_loc' then 'Item Bundles'
    when a.iap_id = 'item_bundle_100k5tick_loc' then 'Item Bundles'
    when a.iap_id = 'item_bundle_3chums_loc' then 'Item Bundles'
    when a.iap_id = 'item_bundle_halloween1_loc' then 'Halloween Offers'
    when a.iap_id = 'item_bundle_halloween2_loc' then 'Halloween Offers'
    when a.iap_id = 'item_bundle_halloween3_loc' then 'Halloween Offers'
    when a.iap_id = 'item_bundle_halloween4_loc' then 'Halloween Offers'
    when a.iap_id = 'item_bundle_halloween5_loc' then 'Halloween Offers'
    when a.iap_id = 'item_chopsticks_loc' then 'Chum Chum Skills'
    when a.iap_id = 'item_096' then 'Chum Chums & Coins'
    when a.iap_id = 'item_096_loc' then 'Chum Chums & Coins'
    when a.iap_id = 'item_bomb_loc' then 'Boosts'
    when a.iap_id = 'item_bomb_bulk_loc' then 'Boosts'
    when a.iap_id = 'item_clear_cell_loc' then 'Chum Chum Skills'
    when a.iap_id = 'item_clear_cell_bulk_loc' then 'Chum Chum Skills'
    when a.iap_id = 'item_clear_horizontal_loc' then 'Chum Chum Skills'
    when a.iap_id = 'item_clear_horizontal_bulk_loc' then 'Chum Chum Skills'
    when a.iap_id = 'item_clear_vertical_loc' then 'Chum Chum Skills'
    when a.iap_id = 'item_clear_vertical_bulk_loc' then 'Chum Chum Skills'
    when a.iap_id = 'item_color_ball_loc' then 'Boosts'
    when a.iap_id = 'item_color_ball_bulk_loc' then 'Boosts'
    when a.iap_id = 'item_disco_loc' then 'Chum Chum Skills'
    when a.iap_id = 'item_rocket_loc' then 'Boosts'
    when a.iap_id = 'item_rocket_bulk_loc' then 'Boosts'
    when a.iap_id = 'item_moves' then 'Chum Chum Skills'
    when a.iap_id = 'item_moves_loc' then 'Chum Chum Skills'
    ...
    when a.iap_id = 'item_moves_bulk' then 'Chum Chum Skills'
    when a.iap_id = 'item_moves_bulk_loc' then 'Chum Chum Skills'
    when a.iap_id = 'item_129' then 'Coins'
    ...
    when a.iap_id = 'item_130' then 'Coins'
    when a.iap_id = 'item_131' then 'Coins'
    when a.iap_id = 'item_132' then 'Coins'
    ...
    when a.iap_id = 'item_133' then 'Level Bundle'
    when a.iap_id = 'item_bundle_bigboostofferlvl100' then 'Level Bundle'
    when a.iap_id = 'item_bundle_sweettreatsofferlvl150' then 'Level Bundle'
    when a.iap_id = 'item_bundle_chumlootofferlvl200' then 'Level Bundle'
    when a.iap_id = 'item_bundle_boostbashofferlvl250' then 'Level Bundle'
    when a.iap_id = 'item_bundle_epicblastofferlvl300' then 'Level Bundle'
    when a.iap_id = 'item_bundle_blastboostofferlvl350' then 'Level Bundle'
    when a.iap_id = 'item_bundle_candyclashofferlvl400' then 'Level Bundle'
    when a.iap_id = 'item_bundle_sugarrushofferlvl450' then 'Level Bundle'
    when a.iap_id = 'item_bundle_flashblastofferlvl50' then 'Level Bundle'
    when a.iap_id = 'item_bundle_starteroffer' then 'Starter Offer'
