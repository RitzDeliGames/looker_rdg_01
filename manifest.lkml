...
constant: iap_id_strings_new {
  ...
  case
    ...
    when ${TABLE}.iap_id = 'item_055' then 'Few More Coins'
    when ${TABLE}.iap_id = 'item_056' then 'More Coins'
    when ${TABLE}.iap_id = 'item_057' then 'A Lot of Coins!'
    when ${TABLE}.iap_id = 'item_058' then 'Few More Lives'
    when ${TABLE}.iap_id = 'item_059' then 'More Lives'
    when ${TABLE}.iap_id = 'item_060' then 'A Lot of Lives!'
...
constant: iap_id_strings_grouped_new {
  value: "
    case
      ${TABLE}.iap_id = 'item_001' then 'Free Machine'
      ${TABLE}.iap_id = 'item_017' then 'Free Machine'
      ${TABLE}.iap_id = 'item_018' then 'Free Machine'
      ${TABLE}.iap_id = 'item_004' then 'Coin Capsule'
      ${TABLE}.iap_id = 'item_005' then 'Coin Capsule'
      ${TABLE}.iap_id = 'item_006' then 'Coin Capsule'
      ${TABLE}.iap_id = 'item_007' then 'Coin Capsule'
      ${TABLE}.iap_id = 'item_020' then 'Coin Capsule'
      ${TABLE}.iap_id = 'item_021' then 'Coin Capsule'
      ${TABLE}.iap_id = 'item_057' then 'Coin Capsule'
      ${TABLE}.iap_id = 'item_008' then 'Gem Capsule'
      ${TABLE}.iap_id = 'item_026' then 'Gem Capsule'
      ${TABLE}.iap_id = 'item_009' then 'Gem Capsule'
      ${TABLE}.iap_id = 'item_010' then 'Gem Capsule'
      ${TABLE}.iap_id = 'item_011' then 'Gem Capsule'
      ${TABLE}.iap_id = 'item_012' then 'Gem Capsule'
      ${TABLE}.iap_id = 'item_013' then 'Gem Capsule'
      ${TABLE}.iap_id = 'item_023' then 'Life Pack'
      ${TABLE}.iap_id = 'item_014' then 'Life Pack'
      ${TABLE}.iap_id = 'item_015' then 'Life Pack'
      ${TABLE}.iap_id = 'item_016' then 'Life Pack'
      ${TABLE}.iap_id = 'item_024' then 'Life Pack'
      ${TABLE}.iap_id = 'item_025' then 'Life Pack'
      ${TABLE}.iap_id = 'item_028' then '24h Infinite Lives'
      ${TABLE}.iap_id = 'item_037' then 'Lives & Coins Bundle'
      ${TABLE}.iap_id = 'boost_001' then 'Boosts'
      ${TABLE}.iap_id = 'boost_002' then 'Boosts'
      ${TABLE}.iap_id = 'boost_003' then 'Boosts'
      ${TABLE}.iap_id = 'boost_004' then 'Boosts'
      ${TABLE}.iap_id = 'boost_005' then 'Boosts'
      ${TABLE}.iap_id = 'boost_006' then 'Boosts'
      ${TABLE}.iap_id = 'box_000' then 'Free Machine'
      ${TABLE}.iap_id = 'box_004' then 'Free Machine'
      ${TABLE}.iap_id = 'box_005' then 'Free Machine'
      ${TABLE}.iap_id like '%clear_cell%' then 'Chum Chum Skills'
      ${TABLE}.iap_id like '%clear_horizontal%' then 'Chum Chum Skills'
      ${TABLE}.iap_id like '%clear_vertical%' then 'Chum Chum Skills'
      ${TABLE}.iap_id like '%bomb%' then 'Pre-Game Boosts'
      ${TABLE}.iap_id like '%rocket%' then 'Pre-Game Boosts'
      ${TABLE}.iap_id like '%color_ball%' then 'Pre-Game Boosts'
      ${TABLE}.iap_id like '%zone%' then 'Zone Restoration'
      ${TABLE}.iap_id like '%extra_moves%' then 'Extra Moves'
      else ${TABLE}.iap_id
  end"
}
