...
constant: release_version_major {
  value: "case
            ...
            when ${TABLE}.version like '11400'then '1.40'
            when ${TABLE}.version like '11500'then '1.50'
          end"
}
...
constant: install_release_version_major {
  value: "case
            ...
            when ${TABLE}.install_version like '11400' then '1.40'
            when ${TABLE}.install_version like '11500' then '1.50'
          end"
}
...
constant: release_version_minor {
  value: "case
            ...
            when ${TABLE}.version like '11400' then '1.11.400'
            when ${TABLE}.version like '11500' then '1.11.500'
          end"
}
...
constant: install_release_version_minor {
  value: "CASE
            ...
            when ${TABLE}.install_version like '11400' then '1.11.400'
            when ${TABLE}.install_version like '11500' then '1.11.500'
          END"
}
...
constant: iap_id_strings {
  value: "case
            ...
            when json_extract_scalar(extra_json,'$.iap_id') like 'item_004' then 'Peewee Coin Machine'
            when json_extract_scalar(extra_json,'$.iap_id') like 'item_005' then 'Small Coin Machine'
            when json_extract_scalar(extra_json,'$.iap_id') like 'item_006' then 'Medium Coin Machine'
            when json_extract_scalar(extra_json,'$.iap_id') like 'item_007' then 'Large Coin Machine'
            when json_extract_scalar(extra_json,'$.iap_id') like 'item_020' then 'Huge Coin Machine'
            when json_extract_scalar(extra_json,'$.iap_id') like 'item_021' then 'Jumbo Coin Machine'
            when json_extract_scalar(extra_json,'$.iap_id') like 'item_008' then 'Peewee Gem Machine'
            when json_extract_scalar(extra_json,'$.iap_id') like 'item_026' then 'Peewee Gem Machine'
            when json_extract_scalar(extra_json,'$.iap_id') like 'item_009' then 'Small Gem Machine'
            when json_extract_scalar(extra_json,'$.iap_id') like 'item_010' then 'Medium Gem Machine'
            when json_extract_scalar(extra_json,'$.iap_id') like 'item_011' then 'Large Gem Machine'
            when json_extract_scalar(extra_json,'$.iap_id') like 'item_012' then 'Huge Gem Machine'
            when json_extract_scalar(extra_json,'$.iap_id') like 'item_013' then 'Jumbo Gem Machine'
...
constant: iap_id_strings_grouped {
  value: "case
            ...
            when json_extract_scalar(extra_json,'$.iap_id') like 'item_004' then 'Coin Machine'
            when json_extract_scalar(extra_json,'$.iap_id') like 'item_005' then 'Coin Machine'
            when json_extract_scalar(extra_json,'$.iap_id') like 'item_006' then 'Coin Machine'
            when json_extract_scalar(extra_json,'$.iap_id') like 'item_007' then 'Coin Machine'
            when json_extract_scalar(extra_json,'$.iap_id') like 'item_020' then 'Coin Machine'
            when json_extract_scalar(extra_json,'$.iap_id') like 'item_021' then 'Coin Machine'
            when json_extract_scalar(extra_json,'$.iap_id') like 'item_008' then 'Gem Machine'
            when json_extract_scalar(extra_json,'$.iap_id') like 'item_026' then 'Gem Machine'
            when json_extract_scalar(extra_json,'$.iap_id') like 'item_009' then 'Gem Machine'
            when json_extract_scalar(extra_json,'$.iap_id') like 'item_010' then 'Gem Machine'
            when json_extract_scalar(extra_json,'$.iap_id') like 'item_011' then 'Gem Machine'
            when json_extract_scalar(extra_json,'$.iap_id') like 'item_012' then 'Gem Machine'
            when json_extract_scalar(extra_json,'$.iap_id') like 'item_013' then 'Gem Machine'
