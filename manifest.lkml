...
constant: singular_creative_simplified_ad_name {
  ...
  case
    ...
    when ${TABLE}.full_ad_name = 'CCB_Airtraffic_TestimonialAI-AsianBaby_25s_1x1_EN.mp4' then 'TestimonialAI-AsianBaby'
    when ${TABLE}.full_ad_name = 'CCB_Airtraffic_TestimonialAI-AsianBaby_25s_9x16_EN.mp4' then 'TestimonialAI-AsianBaby'
    when ${TABLE}.full_ad_name = 'CCB_Airtraffic_TestimonialAI-GirlWithCats_25s_1x1_EN.mp4' then 'TestimonialAI-GirlWithCats'
    when ${TABLE}.full_ad_name = 'CCB_Airtraffic_TestimonialAI-GirlWithCats_25s_9x16_EN.mp4' then 'TestimonialAI-GirlWithCats'
    when ${TABLE}.full_ad_name = 'CCB_Airtraffic_TestimonialAI-HandsomeMan-v01_25s_1x1_EN.mp4' then 'TestimonialAI-HansomeMan'
    when ${TABLE}.full_ad_name = 'CCB_Airtraffic_TestimonialAI-HandsomeMan-v01_25s_9x16_EN.mp4' then 'TestimonialAI-HansomeMan'
    when ${TABLE}.full_ad_name = 'CCB_Airtraffic_TestimonialAI-HandsomeMan-v02_25s_1x1_EN.mp4' then 'TestimonialAI-HansomeMan'
    when ${TABLE}.full_ad_name = 'CCB_Airtraffic_TestimonialAI-HandsomeMan-v02_25s_9x16_EN.mp4' then 'TestimonialAI-HansomeMan'
    when ${TABLE}.full_ad_name = 'CCB_Airtraffic_TestimonialAI-LadyBossWithCats_25s_1x1_EN.mp4' then 'TestimonialAI-LadyBossWithCats'
    when ${TABLE}.full_ad_name = 'CCB_Airtraffic_TestimonialAI-LadyBossWithCats_25s_9x16_EN.mp4' then 'TestimonialAI-LadyBossWithCats'
    when ${TABLE}.full_ad_name = 'CCB_Airtraffic_TestimonialAI-LadyBossWithDogs_25s_1x1_EN.mp4' then 'TestimonialAI-LadyBossWithDogs'
    when ${TABLE}.full_ad_name = 'CCB_Airtraffic_TestimonialAI-LadyBossWithDogs_25s_9x16_EN.mp4' then 'TestimonialAI-LadyBossWithDogs'
    when ${TABLE}.full_ad_name = 'CCB_Airtraffic_TestimonialAI-LoungingWithCats_25s_1x1_EN.mp4' then 'TestimonialAI-LoungingWithCats'
    when ${TABLE}.full_ad_name = 'CCB_Airtraffic_TestimonialAI-LoungingWithCats_25s_9x16_EN.mp4' then 'TestimonialAI-LoungingWithCats'
    when ${TABLE}.full_ad_name = 'CCB_Airtraffic_TestimonialAI-LoungingWithSheep_25s_1x1_EN.mp4' then 'TestimonialAI-LoungingWithSheep'
    when ${TABLE}.full_ad_name = 'CCB_Airtraffic_TestimonialAI-LoungingWithSheep_25s_9x16_EN.mp4' then 'TestimonialAI-LoungingWithSheep'
    when ${TABLE}.full_ad_name = 'CCB_Airtraffic_TestimonialAI-ManOnHorse_25s_1x1_EN.mp4' then 'TestimonialAI-ManOnHorse'
    when ${TABLE}.full_ad_name = 'CCB_Airtraffic_TestimonialAI-ManOnHorse_25s_9x16_EN.mp4' then 'TestimonialAI-ManOnHorse'
    when ${TABLE}.full_ad_name = 'CCB_Airtraffic_TestimonialAI-ManWithHorse_25s_1x1_EN.mp4' then 'TestimonialAI-ManWithHorse'
    when ${TABLE}.full_ad_name = 'CCB_Airtraffic_TestimonialAI-ManWithHorse_25s_9x16_EN.mp4' then 'TestimonialAI-ManWithHorse'
    when ${TABLE}.full_ad_name = 'CCB_Airtraffic_TestimonialAI-PunkAsianGrandma-v01_25s_9x16_EN.mp4' then 'TestimonialAI-PunkAsianGrandma'
    when ${TABLE}.full_ad_name = 'CCB_Airtraffic_TestimonialAI-PunkAsianGrandma-v02_25s_9x16_EN.mp4' then 'TestimonialAI-PunkAsianGrandma'
    when ${TABLE}.full_ad_name = 'CCB_Airtraffic_TestimonialAI-SpinWithKoala_25s_9x16_EN.mp4' then 'TestimonialAI-SpinWithKoala'
    when ${TABLE}.full_ad_name = 'CCB_Airtraffic_TestimonialAI-SpinWithSloth_25s_1x1_EN.mp4' then 'TestimonialAI-SpinWithSloth'
    when ${TABLE}.full_ad_name = 'CCB_Airtraffic_TestimonialAI-SpinWithSloth_25s_9x16_EN.mp4' then 'TestimonialAI-SpinWithSloth'
    when ${TABLE}.full_ad_name = 'CCB_Airtraffic_TestimonialAI-YogaWithSloth-v01_25s_1x1_EN.mp4' then 'TestimonialAI-YogaWithSloth'
    when ${TABLE}.full_ad_name = 'CCB_Airtraffic_TestimonialAI-YogaWithSloth-v01_25s_9x16_EN.mp4' then 'TestimonialAI-YogaWithSloth'
    when ${TABLE}.full_ad_name = 'CCB_Airtraffic_TestimonialAI-YogaWithSloth-v02_25s_1x1_EN.mp4' then 'TestimonialAI-YogaWithSloth'
    when ${TABLE}.full_ad_name = 'CCB_Airtraffic_TestimonialAI-YogaWithSloth-v02_25s_9x16_EN.mp4' then 'TestimonialAI-YogaWithSloth'
