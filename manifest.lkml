...
constant: ad_name_simple {
  ...
  case
    ...
    when ad_name_full = 'AI UGC' then 'AI UGC'
    when ad_name_full = 'CCB_Matej_UGCAI1' then 'UGC AI 1'
    when ad_name_full = 'CCB_Matej_UGCAI2' then 'UGC AI 2'
    when ad_name_full = 'CCB_Matej_UGCAI3' then 'UGC AI 3'
    when ad_name_full = 'CCB_Matej_UGCAI4' then 'UGC AI 4'

    when ad_name_full like '%Altered gameplay%' then 'Altered Gameplay'
    when ad_name_full like '%FarmCars%' then 'Farm Cars'
    when ad_name_full like '%Makeover%' then 'Makeover'
    when ad_name_full like '%Interview%' then 'Interview'
    when ad_name_full like '%IntroThenButts%' then 'Intro Then Butts'
    when ad_name_full like '%FeedingChums%' then 'Feeding Chums'
    when ad_name_full like '%BuildingALevelI%' then 'Building a Level 1'
...
constant: new_singular_creative_name {
  ...
  when creative_name = 'CCB_Matej_UGCAI2' then 'UGC AI 2'
  when creative_name = 'CCB_Matej_UGCAI3' then 'UGC AI 3'
  when creative_name = 'CCB_Matej_UGCAI4' then 'UGC AI 4'

  when creative_name like 'UGC%' then 'UGC'
  when creative_name like 'chum chums%' then 'Chum Chums'
  when creative_name like '%Brain_Female%' then 'Brain Female'
  when creative_name like '%Altered gameplay%' then 'Altered Gameplay'
  when creative_name like '%FarmCars%' then 'Farm Cars'
  when creative_name like '%Makeover%' then 'Makeover'
  when creative_name like '%Interview%' then 'Interview'
  when creative_name like '%IntroThenButts%' then 'Intro Then Butts'
  when creative_name like '%FeedingChums%' then 'Feeding Chums'
  when creative_name like '%BuildingALevelI%' then 'Building a Level 1'
  when creative_name like '%WhatisaChumChum%' then 'What is a Chum Chum'
  when creative_name like '%RedditChallenge%' then 'Reddit Challenge'
  when creative_name like '%PullthePinSalad%' then 'Pull the Pin Salad'
  when creative_name like '%OverTheCliff%' then 'Over The Cliff'
  when creative_name like '%MovesMasterExplanation%' then 'Moves Master Explanation'
  when creative_name like '%HungryChum%' then 'Hungry Chum'
  when creative_name like '%FeedChumChums%' then 'Feed Chum Chums'
  when creative_name like '%CrossBridge%' then 'Cross Bridge'
  when creative_name like '%CoupleBet%' then 'Couple Bet'
  when creative_name like '%TheEggs%' then 'The Eggs'

  when creative_name = 'Other' then 'Other'

  when creative_name like '%RelaxAndUnlock%' then 'Relax And Unlock'
  when creative_name like '%CharacterAppeal_Squirrel_OPPA%' then 'Character Appeal: Oppa'
  when creative_name like '%FlexibleImages%' then 'Flexible Images'
  when creative_name like '%OneMoveLeft%' then 'One Move Left'
  when creative_name like '%AdoptMe%' then 'Adopt Me'
  when creative_name like '%CharacterAppeal_multi%' then 'Character Appeal: Multi'
  when creative_name like '%TapForNoise%' then 'Tab For Noise'
  when creative_name like '%AllTheEggs%' then 'All The Eggs'

  when creative_name like '%MinuteCombo%' then 'Minute Combo'
  when creative_name like '%Meet chum chums%' then 'Meet the Chum Chums'
  when creative_name like '%meet chum chums%' then 'Meet the Chum Chums'
  when creative_name like '%FillTheOrders%' then 'Fill The Orders'
  when creative_name like '%Multiboard%' then 'Multiboard'
  when creative_name like '%MultipleGameplayBright%' then 'Multiple Gameplay Bright'
  when creative_name like '%MultipleGameplay%' then 'Multiple Gameplay'
  when creative_name like '%LevelProgression%' then 'Level Progression'
  when creative_name like '%DesignYourLevel%' then 'Design Your Level'
  when creative_name like '%ImpressiveCascade%' then 'Impressive Cascade'
  when creative_name like '%PostWorkout%' then 'Post Workout'
  when creative_name like '%8BitFoodStart%' then '8Bit Food Start'
  when creative_name like '%MomtoMom%' then 'Mom to Mom'
  when creative_name like '%LongGameplay%' then 'Long Gameplay'
  when creative_name like '%8BitChum%' then '8Bit Chum'
  when creative_name like '%GiantTV%' then 'Giant TV'
  when creative_name like '%WomanToWoman%' then 'Woman To Woman'
  when creative_name like '%cuteness_overload%' then 'Cuteness Overload'
  when creative_name like '%TruthorDare%' then 'Truth or Dare'
  when creative_name like '%ExcuseMe%' then 'Excuse Me'


  when creative_name = 'Bear' then 'CCB Marketability Test - Bear'
  when creative_name = 'Bull' then 'CCB Marketability Test - Bull'
  when creative_name = 'Cat' then 'CCB Marketability Test - Cat'
  when creative_name = 'Chameleon' then 'CCB Marketability Test - Chameleon'
  when creative_name = 'Dog' then 'CCB Marketability Test - Dog'
  when creative_name = 'Fox' then 'CCB Marketability Test - Fox'
  when creative_name = 'Octopus' then 'CCB Marketability Test - Octopus'
  when creative_name = 'Squirrel' then 'CCB Marketability Test - Squirrel'
  when creative_name = 'MultiCharacter1' then 'CCB Marketability Test - MultiCharacter1'
  when creative_name = 'MultiCharacter2' then 'CCB Marketability Test - MultiCharacter2'
  when creative_name = 'MultiCharacter3' then 'CCB Marketability Test - MultiCharacter3'
  ...
  when creative_name like '%Multiboard%' then 'Multiboard'
  when creative_name like '%Mistplay%' then 'Mistplay'

  when creative_name like '%AppStoreTrailer%' then 'App Store Trailer'
  when creative_name like '%APVUpdate%' then 'App Store Trailer'
  when creative_name like '%Asian Baby%' then 'Asian Baby'
  when creative_name like '%ASOTrailer%' then 'App Store Trailer'
  when creative_name like '%Chef%' then 'Chef'
  when creative_name like '%Elevator%' then 'Elevator'
  when creative_name like '%HandsomeMan%' then 'Handsome Man'
  when creative_name like '%Handsome Man%' then 'Handsome Man'
  when creative_name like '%Lady Boss%' then 'Lady Boss'
  when creative_name like '%LadyBoss%' then 'Lady Boss'
  when creative_name like '%ManOnHorse%' then 'Man With Horse'
  when creative_name like '%ManWithHorse%' then 'Man With Horse'
  when creative_name like '%Match3%' then 'Match3'
  when creative_name like '%Playable%' then 'Playable'
  when creative_name like '%Punk Grandma%' then 'Punk Grandma'
  when creative_name like '%Simple Blast%' then 'Simple Blast'
  when creative_name like '%SimpleBlast%' then 'Simple Blast'
  when creative_name like '%Spin Girl%' then 'Spin Girl'
  when creative_name like '%SpinWithKoala%' then 'Spin With Koala'
  when creative_name like '%SpinWithSloth%' then 'Spin With Sloth'
  when creative_name like '%Tilting Table%' then 'Tilting Table'
  when creative_name like '%TiltingTable%' then 'Tilting Table'
  when creative_name like '%WeirdTeddyBear%' then 'WeirdTeddyBear'
  when creative_name like '%Yoga Girl%' then 'Yoga Girl'
  when creative_name like '%YogaWithSloth%' then 'YogaWithSloth'
  when creative_name like '%Zen%' then 'Zen'
  when creative_name like '%App Store Trailer%' then 'App Store Trailer'
  when creative_name like '%SimpleMatch%' then 'SimpleMatch'
  when creative_name like '%SassyDog%' then 'Sassy Dog'
  when creative_name like '%WeirdTreats%' then 'WeirdTreats'
  when creative_name like '%WeirdTeddy%' then 'WeirdTeddyBear'
  when creative_name like '%TTC%' then 'Tilting Table'
  when creative_name like '%GirlWithCats%' then 'Girl With Cats'
  when creative_name like '%AsianBaby%' then 'Asian Baby'
  when creative_name like '%PunkAsianGrandma%' then 'Punk Asian Grandma'
  when creative_name like '%LoungingWithCats%' then 'Lounging With Cats'
  when creative_name like '%LoungingWithSheep%' then 'Lounging With Sheep'
  when creative_name like '%MeetChum%' then 'Meet the Chum Chums'
  when creative_name like '%ChumsPainting%' then 'Chum Chums Painting'
  when creative_name like '%TestimonialAI%' then 'Testimonial (Unmapped AI)'
  ...
  when creative_id = '6301194227322' then 'App Store Trailer'
  when creative_id = '6350278560322' then 'Tilting Table'
  when creative_id = '6353426254522' then 'Spin Girl'
  when creative_id = '6289278657922' then 'App Store Trailer'
  when creative_id = '6442181207722' then 'Tilting Table'
  when creative_id = '6294267214122' then 'App Store Trailer'
  when creative_id = '6460902469922' then 'Spin With Sloth'
  when creative_id = '6444529394922' then 'Tilting Table'
  ...
  when creative_id = '6350253635722' then 'Simple Blast'
  ...
  when creative_id = '6302530847122' then 'App Store Trailer'
  when creative_id = '6460902470922' then 'Handsome Man'
  when creative_id = '6350258071722' then 'App Store Trailer'
  when creative_id = '6451988225122' then 'Handsome Man'
  when creative_id = '6460902468522' then 'Tilting Table'
  ...
  when creative_id = '6350246649322' then 'Tilting Table'
  when creative_id = '6451988224722' then 'Punk Grandma'
  when creative_id = '6294267211322' then 'Tilting Table'
  when creative_id = '6442177689122' then 'Handsome Man'
  when creative_id = '6301409044322' then 'Elevator'
  when creative_id = '6444574033522' then 'Tilting Table'
  ...
  when creative_id = '6288920745122' then 'App Store Trailer'
  ...
  when creative_id = '6301194231722' then 'Tilting Table'
  ...
  when creative_id = '6444526679522' then 'App Store Trailer'
  ...
  when creative_id = '6302530847522' then 'Simple Blast'
  ...
  when creative_id = '6460902470522' then 'App Store Trailer'
  ...
  when creative_id = '6294267212322' then 'Simple Blast'
  when creative_id = '6353426254322' then 'Yoga Girl'
  when creative_id = '6360326687122' then 'App Store Trailer'
  when creative_id = '6294267213522' then 'Simple Blast'
  ...
  when creative_id = '6294267211122' then 'Tilting Table'
  when creative_id = '6365784367322' then 'Asian Baby'
  when creative_id = '6294267215922' then 'App Store Trailer'
  when creative_id = '6301395801322' then 'Tilting Table'
  when creative_id = '6365784368722' then 'Yoga Girl'
  when creative_id = '6289278658122' then 'App Store Trailer'
  ...
  when creative_id = '6289494919122' then 'App Store Trailer'
  ...
  when creative_id = '6289278668322' then 'Simple Blast'
  ...
  when creative_id = '6302530848122' then 'Tilting Table'
  ...
  when creative_id = '6289278668922' then 'Simple Blast'
  ...
  when creative_id = '6289494917922' then 'Simple Blast'
  when creative_id = '6294267216122' then 'Chef'
  when creative_id = '6289278662722' then 'Match3'
  when creative_id = '6289278673322' then 'Tilting Table'
  ...
  when creative_id = '6288922452922' then 'Tilting Table'
  when creative_id = '6289494923722' then 'Tilting Table'
  when creative_id = '6288920744922' then 'App Store Trailer'
  ...
  when creative_id = '6288920761922' then 'Tilting Table'
  ...
  when creative_id = '6288922448122' then 'Tilting Table'
  when creative_id = '6289494921722' then 'Sassy Dog'
  when creative_id = '6288920747322' then 'Chef'
  when creative_id = '6288922448322' then 'Tilting Table'
  when creative_id = '6289278671522' then 'SimpleMatch'
  when creative_id = '6289278657322' then 'App Store Trailer'
  when creative_id = '6289278671322' then 'SimpleMatch'
  when creative_id = '6289278657722' then 'App Store Trailer'
  when creative_id = '6288920746522' then 'App Store Trailer'
  when creative_id = '6289494920922' then 'Zen'
  when creative_id = '6288920758522' then 'Simple Blast'
  ...
  when creative_id = '6288922458322' then 'Simple Blast'
  when creative_id = '6289278659522' then 'Chef'
  when creative_id = '6288920762322' then 'Tilting Table'
  when creative_id = '6302530845922' then 'Tilting Table'
  when creative_id = '6302530847322' then 'Elevator'
  when creative_id = '6289494921922' then 'Zen'
  when creative_id = '6288922455522' then 'App Store Trailer'
  ...
  when creative_id = '6289494923522' then 'Tilting Table'
  ...
  when creative_id = '6289278670922' then 'Tilting Table'
  when creative_id = '6288920745322' then 'App Store Trailer'
  ...
  when creative_id = '6289494917522' then 'Simple Blast'
  ...
  when creative_id = '6288922447922' then 'Tilting Table'
  when creative_id = '6289494923922' then 'Tilting Table'
  when creative_id = '6288922454722' then 'App Store Trailer'
  when creative_id = '6289494920522' then 'Tilting Table'
  when creative_id = '6288922458722' then 'Simple Blast'
  when creative_id = '6288920747122' then 'Chef'
  when creative_id = '6360043117322' then 'Lady Boss'
  when creative_id = '6288920760322' then 'Tilting Table'
  when creative_id = '6289494918722' then 'Elevator'
  when creative_id = '6288922456522' then 'Elevator'
  when creative_id = '6288920754922' then 'Simple Blast'
  ...
  when creative_id = '6289278671122' then 'Tilting Table'
  ...
  when creative_id = '6288920760122' then 'Tilting Table'
  ...
  when creative_id = '6288920754722' then 'Simple Blast'
  when creative_id = '6289494920722' then 'SimpleMatch'
  when creative_id = '6289494919722' then 'App Store Trailer'
  when creative_id = '6288920754522' then 'SimpleMatch'
  when creative_id = '6288922447122' then 'Match3'
  when creative_id = '6288922455722' then 'App Store Trailer'
  when creative_id = '6360043117922' then 'Handsome Man'
  when creative_id = '6288922456722' then 'Simple Blast'
  when creative_id = '6289278672922' then 'Tilting Table'
  when creative_id = '6289494921522' then 'Sassy Dog'
  when creative_id = '6289494918522' then 'Simple Blast'
  ...
  when creative_id = '6500851107322' then 'App Store Trailer'
  ...
  when creative_id = '6527221707522' then 'Tilting Table'
  ...
  when creative_id = '6528145730322' then 'App Store Trailer'
  when creative_id = '6527221707722' then 'App Store Trailer'
...
constant: singular_simple_ad_name {
  ...
  case
    ...
    when asset_name = 'CCB_Matej_UGCAI2' then 'UGC AI 2'
    ...
    when asset_name like '%Interview%' then 'Interview'
    when asset_name like '%IntroThenButts%' then 'Intro Then Butts'
    when asset_name like '%FeedingChums%' then 'Feeding Chums'
    when asset_name like '%BuildingALevelI%' then 'Building a Level 1'
