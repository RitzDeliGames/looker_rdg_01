...
constant: device_os_version_mapping {
  value: "CASE
            ...
            when platform like '%Android OS 4%' THEN 'Android OS 4'
            when platform like '%Android OS 5%' THEN 'Android OS 5'
            when platform like '%Android OS 6%' THEN 'Android OS 6'
            when platform like '%Android OS 7%' THEN 'Android OS 7'
            when platform like '%Android OS 8%' THEN 'Android OS 8'
            when platform like '%Android OS 9%' THEN 'Android OS 9'
