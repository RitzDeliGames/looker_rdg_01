...
constant: release_version_major {
  value: "CASE
            ...
            WHEN ${TABLE}.version LIKE '6001' THEN '1.6'
...
constant: install_release_version_major {
  value: "CASE
            ...
            WHEN ${TABLE}.install_version LIKE '6001' THEN '1.6'
...
constant: release_version_minor {
  value: "CASE
            ...
            WHEN ${TABLE}.version LIKE '6001' THEN '1.6.001'
...
constant: install_release_version_minor {
  value: "CASE
            ...
            WHEN ${TABLE}.install_version LIKE '6001' THEN '1.6.001'
