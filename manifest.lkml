  ...
  case
    ...
    when
      ...
      then ${TABLE}.full_ad_name
       ...
       when ${TABLE}.singular_creative_id = '6500848734322' then 'CCB_TestimonialAI-YogaWithSloth-v01_25s_1x1_EN'
       when ${TABLE}.singular_creative_id = '6501692039722' then 'CCB_Zen_30s_EN'
       when ${TABLE}.singular_creative_id = '6501685619922' then 'CCB_MeetChumChumsPort_22s_EN'
       when ${TABLE}.singular_creative_id = '6500851107322' then 'CCB_APVUpdate_30s_9x16_EN'
       when ${TABLE}.singular_creative_id = '6500850962922' then 'CCB_TestimonialAI-ManWithHorse_25s_1x1_EN'
       when ${TABLE}.singular_creative_id = '6501746012122' then 'CCB_ChumChumsPainting_22s_EN'
...
constant: singular_simple_ad_name {
  ...
  case
      ...
      when ${TABLE}.full_ad_name like '%MeetChum%' then 'Meet the Chum Chums'
      when ${TABLE}.full_ad_name like '%ChumsPainting%' then 'Chum Chums Painting'
      ...
      when ${TABLE}.singular_creative_id = '6500848734322' then 'YogaWithSloth'
      when ${TABLE}.singular_creative_id = '6501692039722' then 'Zen'
      when ${TABLE}.singular_creative_id = '6501685619922' then 'Meet the Chum Chums'
      when ${TABLE}.singular_creative_id = '6500851107322' then 'App Store Trailer'
      when ${TABLE}.singular_creative_id = '6500850962922' then 'Man With Horse'
      when ${TABLE}.singular_creative_id = '6501746012122' then 'Chum Chums Painting'
...
constant: singular_grouped_ad_name {
  ...
  case
    ...
    when ${TABLE}.singular_creative_id = '6500848734322' then 'AI'
    when ${TABLE}.singular_creative_id = '6501692039722' then 'Zen'
    when ${TABLE}.singular_creative_id = '6501685619922' then 'Meet the Chum Chums'
    when ${TABLE}.singular_creative_id = '6500851107322' then 'App Store Trailer'
    when ${TABLE}.singular_creative_id = '6500850962922' then 'AI'
    when ${TABLE}.singular_creative_id = '6501746012122' then 'Chum Chums Painting'
