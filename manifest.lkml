...
constant: release_version_major {
  value: "CASE
            WHEN ${TABLE}.version LIKE '1568' THEN 'r1.0'
            WHEN ${TABLE}.version LIKE '1579' THEN 'r1.0'
            WHEN ${TABLE}.version LIKE '2047' THEN 'r1.1'
            WHEN ${TABLE}.version LIKE '2100' THEN 'r1.1'
            WHEN ${TABLE}.version LIKE '3028' THEN 'r1.2'
            WHEN ${TABLE}.version LIKE '3043' THEN 'r1.2'
            WHEN ${TABLE}.version LIKE '3100' THEN 'r1.2'
            WHEN ${TABLE}.version LIKE '4017' THEN 'r1.3'
            WHEN ${TABLE}.version LIKE '4100' THEN 'r1.3'
            WHEN ${TABLE}.version LIKE '5006' THEN 'r1.5'
            WHEN ${TABLE}.version LIKE '5100' THEN 'r1.5'
            WHEN ${TABLE}.version LIKE '6001' THEN 'r1.6'
            WHEN ${TABLE}.version LIKE '6100' THEN 'r1.6'
            WHEN ${TABLE}.version LIKE '6200' THEN 'r1.6'
            WHEN ${TABLE}.version LIKE '6300' THEN 'r1.6'
            WHEN ${TABLE}.version LIKE '6400' THEN 'r1.6'
            WHEN ${TABLE}.version LIKE '7100' THEN 'r1.7'
            WHEN ${TABLE}.version LIKE '7200' THEN 'r1.7'
            WHEN ${TABLE}.version LIKE '7300' THEN 'r1.7'
            WHEN ${TABLE}.version LIKE '7400' THEN 'r1.7'
            WHEN ${TABLE}.version LIKE '7500' THEN 'r1.7'
            WHEN ${TABLE}.version LIKE '7600' THEN 'r1.7'
        END"
}

constant: install_release_version_major {
  value: "CASE
            WHEN ${TABLE}.install_version LIKE '1568' THEN 'r1.0'
            WHEN ${TABLE}.install_version LIKE '1579' THEN 'r1.0'
            WHEN ${TABLE}.install_version LIKE '2047' THEN 'r1.1'
            WHEN ${TABLE}.install_version LIKE '2100' THEN 'r1.1'
            WHEN ${TABLE}.install_version LIKE '3028' THEN 'r1.2'
            WHEN ${TABLE}.install_version LIKE '3043' THEN 'r1.2'
            WHEN ${TABLE}.install_version LIKE '3100' THEN 'r1.2'
            WHEN ${TABLE}.install_version LIKE '4017' THEN 'r1.3'
            WHEN ${TABLE}.install_version LIKE '4100' THEN 'r1.3'
            WHEN ${TABLE}.install_version LIKE '5006' THEN 'r1.5'
            WHEN ${TABLE}.install_version LIKE '5100' THEN 'r1.5'
            WHEN ${TABLE}.install_version LIKE '6001' THEN 'r1.6'
            WHEN ${TABLE}.install_version LIKE '6100' THEN 'r1.6'
            WHEN ${TABLE}.install_version LIKE '6200' THEN 'r1.6'
            WHEN ${TABLE}.install_version LIKE '6300' THEN 'r1.6'
            WHEN ${TABLE}.install_version LIKE '6400' THEN 'r1.6'
            WHEN ${TABLE}.install_version LIKE '7100' THEN 'r1.7'
            WHEN ${TABLE}.install_version LIKE '7200' THEN 'r1.7'
            WHEN ${TABLE}.install_version LIKE '7300' THEN 'r1.7'
            WHEN ${TABLE}.install_version LIKE '7400' THEN 'r1.7'
            WHEN ${TABLE}.install_version LIKE '7500' THEN 'r1.7'
            WHEN ${TABLE}.install_version LIKE '7600' THEN 'r1.7'
        END"
}

constant: release_version_minor {
  value: "CASE
            WHEN ${TABLE}.version LIKE '1568' THEN 'r1.0.001'
            WHEN ${TABLE}.version LIKE '1579' THEN 'r1.0.100'
            WHEN ${TABLE}.version LIKE '2047' THEN 'r1.1.001'
            WHEN ${TABLE}.version LIKE '2100' THEN 'r1.1.100'
            WHEN ${TABLE}.version LIKE '3028' THEN 'r1.2.028'
            WHEN ${TABLE}.version LIKE '3043' THEN 'r1.2.043'
            WHEN ${TABLE}.version LIKE '3100' THEN 'r1.2.100'
            WHEN ${TABLE}.version LIKE '4017' THEN 'r1.3.017'
            WHEN ${TABLE}.version LIKE '4100' THEN 'r1.3.100'
            WHEN ${TABLE}.version LIKE '5006' THEN 'r1.5.006'
            WHEN ${TABLE}.version LIKE '5100' THEN 'r1.5.100'
            WHEN ${TABLE}.version LIKE '6001' THEN 'r1.6.001'
            WHEN ${TABLE}.version LIKE '6100' THEN 'r1.6.100'
            WHEN ${TABLE}.version LIKE '6200' THEN 'r1.6.200'
            WHEN ${TABLE}.version LIKE '6300' THEN 'r1.6.300'
            WHEN ${TABLE}.version LIKE '6400' THEN 'r1.6.400'
            WHEN ${TABLE}.version LIKE '7100' THEN 'r1.7.100'
            WHEN ${TABLE}.version LIKE '7200' THEN 'r1.7.200'
            WHEN ${TABLE}.version LIKE '7300' THEN 'r1.7.300'
            WHEN ${TABLE}.version LIKE '7400' THEN 'r1.7.400'
            WHEN ${TABLE}.version LIKE '7500' THEN 'r1.7.500'
            WHEN ${TABLE}.version LIKE '7600' THEN 'r1.7.600'
          END"
}

constant: install_release_version_minor {
  value: "CASE
            WHEN ${TABLE}.install_version LIKE '1568' THEN 'r1.0.001'
            WHEN ${TABLE}.install_version LIKE '1579' THEN 'r1.0.100'
            WHEN ${TABLE}.install_version LIKE '2047' THEN 'r1.1.001'
            WHEN ${TABLE}.install_version LIKE '2100' THEN 'r1.1.100'
            WHEN ${TABLE}.install_version LIKE '3028' THEN 'r1.2.028'
            WHEN ${TABLE}.install_version LIKE '3043' THEN 'r1.2.043'
            WHEN ${TABLE}.install_version LIKE '3100' THEN 'r1.2.100'
            WHEN ${TABLE}.install_version LIKE '4017' THEN 'r1.3.017'
            WHEN ${TABLE}.install_version LIKE '4100' THEN 'r1.3.100'
            WHEN ${TABLE}.install_version LIKE '5006' THEN 'r1.5.006'
            WHEN ${TABLE}.install_version LIKE '5100' THEN 'r1.5.100'
            WHEN ${TABLE}.install_version LIKE '6001' THEN 'r1.6.001'
            WHEN ${TABLE}.install_version LIKE '6100' THEN 'r1.6.100'
            WHEN ${TABLE}.install_version LIKE '6200' THEN 'r1.6.200'
            WHEN ${TABLE}.install_version LIKE '6300' THEN 'r1.6.300'
            WHEN ${TABLE}.install_version LIKE '6400' THEN 'r1.6.400'
            WHEN ${TABLE}.install_version LIKE '7100' THEN 'r1.7.100'
            WHEN ${TABLE}.install_version LIKE '7200' THEN 'r1.7.200'
            WHEN ${TABLE}.install_version LIKE '7300' THEN 'r1.7.300'
            WHEN ${TABLE}.install_version LIKE '7400' THEN 'r1.7.400'
            WHEN ${TABLE}.install_version LIKE '7500' THEN 'r1.7.500'
            WHEN ${TABLE}.install_version LIKE '7600' THEN 'r1.7.600'
          END"
}
