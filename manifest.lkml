...
constant: button_tags {
  value: "case
            ...
            when json_extract_scalar(extra_json,'$.button_tag') like 'EndlessTreasure.et%' then 'Endless Treasure - Open'
...
constant: campaign_name_clean {
  value: "case
            ...
            when ${TABLE}.campaign_name = 'Android_AAA_Events_Purchase_Women&Men_LATAM/PTBR_N/A_v2' then 'AAA - LATAM/BR - Purchase (App Promo)'
            when ${TABLE}.campaign_name = 'Android_AAA_Events_Purchase_Women&Men_LATAM/ES_N/A' then 'AAA - LATAM/ES - Purchase'
            when ${TABLE}.campaign_name = 'Android_AAA_Events_Purchase_Women&Men_LATAM/ES_N/A_v2' then 'AAA - LATAM/ES - Purchase (App Promo)'
