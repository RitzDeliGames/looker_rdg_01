...
constant: campaign_name_clean_update {
  value: "case
            when
              ...
              then '20230413 - Android - Facebook - LATAM/ES - 15 Min'


            when campaign_name = 'CHUM|Facebook|Android|US|AA+|20240307' then '20240307 - Android - Facebook - USA - Purchase'

            when campaign_name = 'CHUM|Facebook|Android|LATAM-ES|AA+|Mar03' then '20240303 - Android - Facebook - LATAM/ES - 30 Min'

            when campaign_name = 'CHUM|Facebook|Android|US|AA+|Jan24' then '20240103 - Android - Facebook - USA - Purchase'

            when campaign_name = 'Android_AAA+_30_Minutes_MX_20231214' then '20231214 - Android - Facebook - MX - 30 Min'

            when campaign_name = 'Android_AAA+_30_Minutes_MX_20231129' then '20231129 - Android - Facebook - MX - 30 Min'

            when campaign_name = 'Android_AAA+_MAI_US_20231110' then '20231110 - Android - Facebook - USA - Install'
            when campaign_name = 'Android_AAA+TutorialComplete_US_20231030' then '20231030 - Android - Facebook - USA - Tutorial Complete'

            when campaign_name = 'Android_AAA+_30_Minutes_LATAM/ES_20231019' then '20231019 - Android - Facebook - LATAM/ES - 30 Min'
            when campaign_name = 'iOS_AAA+_Install_LATAM/ES_20231019' then '20231019 - Android - Facebook - LATAM/ES - 30 Min'

            when campaign_name = 'Android_AAA+_30_Minutes_US_20230828' then '20230828 - Android - Facebook - USA - 30 Min'
            when campaign_name = 'Android_AAA+_60_Minutes_US_20230825' then '20230825 - Android - Facebook - USA - 60 Min'
            when campaign_name = 'Android_AAA_MAI_US_20230705' then '20230705 - Android - Facebook - USA - Install'
            when campaign_name = 'Android_AAA_Events_Purchase_Women&Men_US_N/A' then '20230131 - Android - Facebook - USA - Purchase'
            when campaign_name = 'Android_AAA_Purchase_US_20230523' then '20230523 - Android - Facebook - USA - Purchase'
            when campaign_name = 'Android_AAA+_Purchase_US_20230808' then '20230808 - Android - Facebook - USA - Purchase'
            when campaign_name = 'Android_AAA+_Purchase_US_20230809' then '20230808 - Android - Facebook - USA - Purchase'
            when campaign_name = 'Android_AAA_Events_15_Minutes_Women&Men_US_N/A' then '20230308 - Android - Facebook - USA - 15 Min'
            when campaign_name = 'Android_AAA_15_Minutes_US_20230427' then '20230427 - Android - Facebook - USA - 15 Min'
            when campaign_name = 'Android_AAA_30_Minutes_US_20230710' then '20230710 - Android - Facebook - USA - 30 Min'
            when campaign_name = 'Android_AAA+_30_Minutes_US_20230721' then '20230721 - Android - Facebook - USA - 30 Min'
            ...
            when campaign_name = 'Android_AAA_15_Minutes_LATAM/ES_20230413' then '20230413 - Android - Facebook - LATAM/ES - 15 Min'
            when campaign_name = 'Android_AAA_15_Minutes_LATAM/ES_20230510' then '20230510 - Android - Facebook - LATAM/ES - 15 Min'
            when campaign_name = 'Android_AAA_15_Minutes_LATAM/ES_20230523' then '20230523 - Android - Facebook - LATAM/ES - 15 Min'
            when campaign_name = 'Android_AAA_15_Minutes_LATAM/ES_20230607' then '20230607 - Android - Facebook - LATAM/ES - 15 Min'
            when campaign_name = 'Android_AAA_15_Minutes_LATAM/ES_20230807' then '20230807 - Android - Facebook - LATAM/ES - 15 Min'
            when campaign_name = 'Android_AAA_30_Minutes_LATAM/ES_20230717' then '20230717 - Android - Facebook - LATAM/ES - 30 Min'
...
constant: bfg_campaign_name_mapping {
  value: "
    case
      ...
      when lower(b.campaign) like 'ccb|fb|rdg|android|us|aeo|60minutes|2024.08.14_1539485%' then '20240830 - Android - Facebook - USA - 60 Min'
      when lower(b.campaign) = 'ccb|fb|rdg|android|latam|aeo|tutorialcomplete|1_1539505' then '20240819 - Android - Facebook - LATAM - Tutorial Complete'
      when lower(b.campaign) = 'ccb|fb|rdg|android|latam|aeo|tutorialcomplete|2_1539506' then '20240819 - Android - Facebook - LATAM - Tutorial Complete'
      when lower(b.campaign) = 'ccb|fb|rdg|android|latam|aeo|tutorialcomplete|2024.08.19_1539506' then '20240819 - Android - Facebook - LATAM - Tutorial Complete'
      when lower(b.campaign) = 'ccb|fb|rdg|android|us|aeo|purchase|2024.08.06_1535953' then '20240806 - Android - Facebook - USA - Purchase'
      when lower(b.campaign) = 'ccb|fb|rdg|android|us|aeo|tutorialcomplete|2024.08.02|_1535951' then '20240802 - Android - Facebook - USA - Tutorial Complete'
      when lower(b.campaign) = 'ccb|rdg|facebook|creativetest|android|us|mai|rdgapp|jul24_1533998' then '20240801 - Android - Facebook - USA - Creative Test'
      when lower(b.campaign) = 'ccb|rdg|facebook|android|latam|aa+|aeo|tutorial|rdgapp|localized|jul24_1534808' then '20240801 - Android - Facebook - LATAM - Tutorial Complete'
      when lower(b.campaign) = 'ccb|rdg|facebook|install|android|us|mai|rdgapp|jul24_1534693' then '20240731 - Android - Facebook - USA - MAI'
      when lower(b.campaign) = 'ccb|rdg|facebook|android|latam|aa+|aeo|tutorial|rdgapp|jul24_1532599' then '20240725 - Android - Facebook - LATAM - Tutorial Complete'
      when lower(b.campaign) = 'ccb|rdg|facebook|android|latam|aa+|aeo|engagement60|jul24_1526475' then '20240710 - Android - Facebook - LATAM - 60 Min'
      when lower(b.campaign) = 'ccb|rdg|facebook|android|latam|aa+|aeo|tutorial|jul24_1526471' then '20240710 - Android - Facebook - LATAM - Tutorial Complete'
      when lower(b.campaign) = 'ccb|rdg|facebook|android|latam|aa+|aeo|tutorial|jul24_1526879' then '20240710 - Android - Facebook - LATAM - Tutorial Complete'
      when lower(b.campaign) = 'ccb|rdg|facebook|android|us|aa+|aeo|tutorial|jul24_1522313' then '20240703 - Android - Facebook - USA - Tutorial Complete'
      when lower(b.campaign) = 'ccb|rdg|facebook|android|latam|aa+|aeo|tutorial|jun24_1520208' then '20240624 - Android - Facebook - LATAM - Tutorial Complete'
      when lower(b.campaign) = 'ccb|android|facebook|us|charactermarketability|linkclick|cell1|may24_1507641' then '20240524 - Android - Facebook - USA - Marketability'
      when lower(b.campaign) = 'ccb|android|facebook|us|charactermarketability|linkclick|cell2|may24_1507648' then '20240524 - Android - Facebook - USA - Marketability'
      when lower(b.campaign) = 'ccb|android|facebook|us|charactermarketability|linkclick|cell3|may24_1507652' then '20240524 - Android - Facebook - USA - Marketability'
      when lower(b.campaign) = 'chum|facebook|android|latam|aa+|mai|apr24_137769' then '20240424 - Android - Facebook - LATAM - MAI'
      when lower(b.campaign) = 'chum|facebook|android|us|aa+|aeo|apr24_1500678' then '20240424 - Android - Facebook - USA - Purchase'
      when lower(b.campaign) = 'chum|facebook|android|us|aa+|aeo|may24_1506781' then '20240524 - Android - Facebook - USA - Purchase'
      when lower(b.campaign) = 'chum|facebook|creativetest|android|us|mai|may24_1508328' then '20240524 - Android - Facebook - USA - Creative Test'
      when lower(b.campaign) = 'mistplay-ccb-android-os12-us-roasopti-all18_137763' then '20240424 - Android - Mistplay - USA - ROAS'
      when lower(b.campaign) = 'ccb|facebook|android|us|aa+|mai|may24_1510798' then '20240524 - Android - Facebook - USA - MAI'
      when lower(b.campaign) = 'chum|facebook|ios|latam|aa+|mai|apr24_137765' then '20240424 - Android - Facebook - LATAM - MAI'
      when lower(b.campaign) = 'chum|facebook|creativetest|android|us|aa+|mai|may24_1508328' then '20240524 - Android - Facebook - USA - Creative Test'
      when lower(b.campaign) = 'ccb|rdg|facebook|android|us|aa+|aeo|tutorialcomplete|may24_1510911' then '20240530 - Android - Facebook - USA - Tutorial Complete'
      when lower(b.campaign) = 'ccb|rdg|facebook|creativetest|android|us|mai|may24_1510912' then '20240530 - Android - Facebook - USA - Creative Test'
      when lower(b.campaign) = 'ccb|rdg|facebook|android|us|aa+|aeo|purchase|may24_1510988' then '20240605 - Android - Facebook - USA - Purchase'
