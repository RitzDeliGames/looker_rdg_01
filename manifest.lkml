...
constant: release_version_minor {
  value: "case
            ...
            when ${TABLE}.version like '12500' then '1.12.500'
            ...
            when ${TABLE}.version like '12860' then '1.12.860'
            when ${TABLE}.version like '12870' then '1.12.870'
          end"
}
...
constant: install_release_version_minor {
  value: "case
            ...
            when ${TABLE}.install_version like '12500' then '1.12.500'
            ...
            when ${TABLE}.install_version like '12860' then '1.12.860'
            when ${TABLE}.install_version like '12870' then '1.12.870'
          end"
}
...
constant: campaign_name_clean {
  value: "case
            ...
            when ${TABLE}.campaign_name = 'Android_AAA_Installs_5_Minutes_Event_Women&Men_LATAM/ES_N/A v2' then 'AAA - 5 Min'
            when ${TABLE}.campaign_name = 'Art_Test_Android_Manual_Installs_No_Event_Women&Men_LATAM/ES_Puzzle Games' then 'MAI - No Event - Puzzle Games 2'
            when ${TABLE}.campaign_name = 'Android_Manual_Installs_No_Event_Women&Men_LATAM/ES_Puzzle Games' then 'MAI - No Event - Puzzle Games'
            when ${TABLE}.campaign_name = 'Android_Manual_Installs_5_Minutes_Event_Women&Men_LATAM/ES_Puzzle Games' then 'MAI - 5 Min - Puzzle Games'
            when ${TABLE}.campaign_name = 'Android_Manual_Installs_No_Event_Women&Men_LATAM/ES_Candy Crush' then 'MAI - No Event - Candy Crush'
            when ${TABLE}.campaign_name = 'Android_Manual_Installs_5_Minutes_Event_Women&Men_LATAM/ES_Candy Crush' then 'MAI - 5 Min - Candy Crush'
            ...
            when ${TABLE}.campaign_name = 'Android_Manual_Installs_5_Minutes_Event_Women&Men_LATAM/ES_Puzzle&Decorate' then 'MAI - 5 Min - Puzzle & Decorate'
            when ${TABLE}.campaign_name = 'Android_Manual_Installs_No_Event_Women&Men_LATAM/ES_Coin_Master' then 'MAI - No Event - Coin Master'
            when ${TABLE}.campaign_name = 'Android_Manual_Installs_5_Minutes_Event_Women&Men_LATAM/ES_Coin_Master' then 'MAI - 5 Min - Coin Master'
            ...
            when ${TABLE}.campaign_name = 'Android_Manual_Installs_5_Minutes_Event_Women&Men_LATAM/ES_LATAM/MX - LAL - 1% - L7D_4+' then 'MAI - 5 Min - 4 of 7 Days'
