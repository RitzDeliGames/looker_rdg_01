explore: distribution_of_completed_cards_by_time {}

view: distribution_of_completed_cards_by_time {
  derived_table: {
    sql: SELECT
  ...
  set: detail {
    fields: [_000_bingo_cards_comp_event_date, _000_bingo_cards_comp_user_first_seen_date, _000_bingo_cards_comp_days_since_install, card_end_measure]
  }
}
