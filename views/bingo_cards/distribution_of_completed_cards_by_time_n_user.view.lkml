view: distribution_of_completed_cards_by_time_n_user {
  derived_table: {
    sql: SELECT
        ...
        _000_bingo_cards_comp.user_id  AS _000_bingo_cards_comp_player_id,
  ...
  dimension: player_id {
    type: string
    sql: ${TABLE}._000_bingo_cards_comp_player_id ;;
  }
  ...
  set: detail {
    fields: [user_first_seen_date, days_since_install, player_id, card_end_measure]
  }
}
