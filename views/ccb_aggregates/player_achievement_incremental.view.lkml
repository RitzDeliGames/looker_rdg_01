view: player_achievement_incremental {
  ...
  derived_table: {
    sql:
      ...
      when date(current_date()) <= '2024-12-11' -- Last Full Update
      then '2024-07-01' -- first achievements date
      ...
      and event_name = 'Achievements' -- button clicks
