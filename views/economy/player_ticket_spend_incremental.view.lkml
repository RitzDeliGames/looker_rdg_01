view: player_ticket_spend_incremental {
    ...
    sql:
      ...
      base_data as (
          ...
          where
              ...
              and json_extract_scalar(extra_json,"$.transaction_purchase_currency") = 'TICKET' -- ticket spend
          )
      ...
      , get_data_from_extra_json as (
          ...
          select
              ...
              -- purchase amount
                , ifnull(safe_cast(json_extract_scalar(extra_json,"$.transaction_purchase_amount") as numeric) ,0) tickets_spend
              ...
              , safe_cast(json_extract_scalar(currencies,"$.TICKET") as numeric) tickets_balance
