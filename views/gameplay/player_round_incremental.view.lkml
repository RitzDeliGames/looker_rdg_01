      ...
      with
        ...
        , get_round_ends_events_only as (
            ...
            select
                ...
                -- active game modes
                , safe_cast(json_extract_scalar(extra_json, "$.flour_frenzy") as boolean) as is_active_flour_frenzy
                , safe_cast(json_extract_scalar(extra_json, "$.donut_sprint") as boolean) as is_active_donut_sprint
                , safe_cast(json_extract_scalar(extra_json, "$.castle_climb") as boolean) as is_active_castle_climb
                , safe_cast(json_extract_scalar(extra_json, "$.hotdog_contest") as boolean) as is_active_hotdog_contest
        ...
        select
          ...
          -- active game modes
          , max(is_active_flour_frenzy) as is_active_flour_frenzy
          , max(is_active_donut_sprint) as is_active_donut_sprint
          , max(is_active_castle_climb) as is_active_castle_climb
          , max(is_active_hotdog_contest) as is_active_hotdog_contest
