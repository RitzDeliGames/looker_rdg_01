...
view: gaming_block_funnel_explorer {
  ...
  derived_table: {
    sql: SELECT sessions.unique_session_id as unique_session_id
      ...
      FROM ${gaming_block_events_sessionized.SQL_TABLE_NAME} AS events_sessionized
      LEFT JOIN ${gaming_block_sessions.SQL_TABLE_NAME} AS sessions
