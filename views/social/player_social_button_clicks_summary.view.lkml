view: player_social_button_clicks_summary {
  ...
  derived_table: {
    sql:
      ...
      select
      *
      , @{social_categories} as social_categories
      ...
      from
      ${player_social_button_clicks_incremental.SQL_TABLE_NAME}
...
####################################################################
  ...
  dimension: social_categories {
    group_label: "Social Category Mapping"
    type:  string
  }
...
####################################################################
  ...
  measure: sum_button_clicks {
    type: sum
    sql: ${TABLE}.count_button_clicks ;;
  }
