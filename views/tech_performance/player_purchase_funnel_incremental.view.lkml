view: player_purchase_funnel_incremental {
  ...
  derived_table: {
    sql:
      ...
      base_data as (
        ...
        date(timestamp) >=
        case
        when date(current_date()) <= '2024-12-06' -- Last Full Update
        then '2024-11-14' -- purchase funnel start
