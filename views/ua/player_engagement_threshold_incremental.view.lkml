view: player_engagement_threshold_incremental {
  ...
  derived_table: {
    sql:
      ...
      when date(current_date()) <= '2024-12-17' -- Last Full Update
      then '2022-06-01' -- first date
      ...
      and event_name = 'EngagementThresholdCrossed'
